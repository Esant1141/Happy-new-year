        ...
        <div className='frist'>
          <div className="table center">
            <div className="monitor-wrapper center">
              <div className="monitor center">{formSubmitted?(  <p> Wishing yo a very Happy New Year to you and your family {formName} And Thankyou So Much For Giving Me Your Mobile No {formPhoneNumber} By the way I Know Your Name But I Thougth I should Add For You Also I Got Your Wish {formWish} </p>
              ):null}
              </div>
            </div>
          </div>
